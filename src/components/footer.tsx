import { TITLE_WEB, LOGO_DIRECTION } from '../web.config';

export function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-gray-800 rounded-xl">
      <div className="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
        ...
        <div className="text-center">
          ...
          >
            <img src={LOGO_DIRECTION} alt="logo-web" className="w-10 rounded-full mr-2" /> {TITLE_WEB}
          </a>
