...
<p align= "center">
    <img alt="preview_image" src="./assets/Neovim.Config (1).png" />
    <img alt="preview_image" src="./assets/Neovim.Config (2).png" />
    <img alt="preview_image" src="./assets/Neovim.Config (3).png" />
</p>
