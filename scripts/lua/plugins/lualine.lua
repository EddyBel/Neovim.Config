    ...
    config = function()
        ...
        require("lualine").setup({
            ...
            sections = {
                ...
                lualine_c = { branch },
                lualine_x = { INFORMATION_UTILITIES.neoformat_formatter, INFORMATION_UTILITIES.number_lsp_clients,
                    diagnostic },
                lualine_y = { INFORMATION_UTILITIES.lsp_clients_by_typefile, progress },
